...
def test_list_repos_returns_200_with_repo_list_for_valid_request(mock_client, auth_mock, action_mock, user):
    # Arrange
...
def test_list_repos_returns_403_when_not_admin(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
...
def test_get_repo_returns_404_on_nonexistent_repo(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
    action_mock.get_action_repository_by_id.side_effect = NonexistentActionRepositoryError(3)
...
def test_create_repo_returns_200_and_creates_repo_for_valid_request(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
...
def test_create_repo_returns_401_when_not_logged_in(mock_client, auth_mock, action_mock):
    # Arrange
    auth_mock.get_as_non_admin_user.side_effect = NotLoggedInError()    
    auth_mock.get_as_admin_user.side_effect = NotLoggedInError()
...
def test_create_repo_returns_403_when_not_admin(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user    
    auth_mock.get_as_admin_user.side_effect = AdminRequiredError()
...
def test_update_repo_returns_200_and_updates_repo_for_simple_request(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
...
def test_update_repo_returns_200_and_updates_repo_proper_setters_for_complex_request(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
...
def test_update_repo_returns_401_when_not_logged_in(mock_client, auth_mock, action_mock):
    # Arrange
    auth_mock.get_as_non_admin_user.side_effect = NotLoggedInError()
    auth_mock.get_as_admin_user.side_effect = NotLoggedInError()
...
def test_update_repo_returns_404_on_nonexistent_repo(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
    action_mock.update_action_repository.side_effect = NonexistentActionRepositoryError(3)
...
def test_delete_repo_returns_200_and_deletes_repo_for_valid_request(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
...
def test_delete_repo_returns_401_when_not_logged_in(mock_client, auth_mock, action_mock):
    # Arrange
    auth_mock.get_as_non_admin_user.side_effect = NotLoggedInError()
    auth_mock.get_as_admin_user.side_effect = NotLoggedInError()
...
def test_delete_repo_returns_403_when_not_admin(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.side_effect = AdminRequiredError()
...
def test_delete_repo_returns_404_for_nonexistent_repo(mock_client, auth_mock, action_mock, user):
    # Arrange
    auth_mock.get_as_non_admin_user.return_value = user
    auth_mock.get_as_admin_user.return_value = user
    action_mock.remove_action_repository.side_effect = NonexistentActionRepositoryError(3)
