...
class Invocation(Base):
    ...
    function_name_semantically_valid: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    params_semantically_valid: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)