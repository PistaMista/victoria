...
from app.services.llm import LLMService, NonexistentConnectionError, OllamaCommunicationError
from app.model.user import User
from app.containers import Container
from dependency_injector.wiring import inject, Provide
from .schema.connections import ConnectionListItemResponse, ConnectionResponse, ConnectionCreate, ConnectionUpdate
...
async def create_connection(
    ...
    try:
        new_id = llm_service.add_ollama_connection(
            name=body.name,
            url=body.url
        )
...
async def update_connection(
    ...
    try:
        llm_service.update_ollama_connection(
            id=id,
