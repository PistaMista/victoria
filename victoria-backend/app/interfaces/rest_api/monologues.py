...
from .schema.monologues import MonologueEnd, MonologueListItemResponse, MonologueResponse, ThoughtResponse, to_monologue_list_item_response, to_monologue_response, to_thought_response
...
async def list_monologues(
    ...
    monologue_service: Annotated[MonologueService, Depends(Provide[Container.monologue])]
) -> List[MonologueListItemResponse]:
    monologues = monologue_service.get_user_monologues(
        user_id=user.id
    )
