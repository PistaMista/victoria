...
test('monologue list view can filter by trigger', async () => {
    ...
    expect((listMonologuesHandler as Mock).mock.calls[2][0].request.url).toContain("trigger=4");
    ...
    expect((listMonologuesHandler as Mock).mock.calls[3][0].request.url).not.toContain("trigger=");
})
...
test('monologue list view can filter by monologue status', async () => {
    ...
    expect(listMonologuesHandler).toBeCalledTimes(3);
    expect((listMonologuesHandler as Mock).mock.calls[2][0].request.url).toContain("monologueStatus=RUNNING");
    ...
    expect(listMonologuesHandler).toBeCalledTimes(4);
    expect((listMonologuesHandler as Mock).mock.calls[3][0].request.url).not.toContain("monologueStatus=");
})
...
test('monologue list view can filter by assigned agent', async () => {
    ...
    expect(listMonologuesHandler).toBeCalledTimes(3);
    expect((listMonologuesHandler as Mock).mock.calls[2][0].request.url).toContain("assignedAgent=1");
    ...
    expect(listMonologuesHandler).toBeCalledTimes(4);
    expect((listMonologuesHandler as Mock).mock.calls[3][0].request.url).not.toContain("assignedAgent=");
})
...
test('monologue list view can search for monologues', async () => {
    ...
    await waitFor(() => {
        expect(listMonologuesHandler).toBeCalledTimes(3);
        expect((listMonologuesHandler as Mock).mock.calls[2][0].request.url).toContain("searchQuery=random");
    })
})