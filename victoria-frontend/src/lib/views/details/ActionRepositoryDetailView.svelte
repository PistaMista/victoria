<script lang="ts">
	...
	import {
		...
		deleteActionRepository,
		getActionRepository,
		updateActionRepository,
	} from "$lib/api/action_repositories";
		...
		>
			...
			>
				<DetailView backRoute="/admin/actions">
					...
					{#if id === null}
						<DetailViewSection
							title="Create action repository"
						>
							<CreateButton
					...
					{:else}
						<DetailViewSection
							title="Delete action repository"
						>
							<DeleteButton
								aria-label="Delete action repository"
								onclick={deleteRepo}
							/>
						</DetailViewSection>

						<DetailViewSection
							title="Save action repository"
						>
							<SaveButton
								aria-label="Save action repository"
								onclick={saveRepo}
							/>
						</DetailViewSection>
					{/if}
